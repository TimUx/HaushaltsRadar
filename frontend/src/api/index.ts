...
export const analyticsApi = {
  dashboard: (params?: DashboardFilters) => {
    ...
    return apiFetch<DashboardSummary>(`/analytics/dashboard${query ? `?${query}` : ''}`)
  },
  filterOptions: () =>
    apiFetch<{
  ...
  costOverview: () => apiFetch<CostOverviewRow[]>('/analytics/cost-overview'),
}
...
export const categoriesApi = {
  ...
  createSubcategory: (categoryId: number, body: { name: string; sort_order?: number }) =>
    apiFetch(
